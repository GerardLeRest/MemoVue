...
class frame_droite_haute(tk.Frame):
    ...
    def __init__(self, fenetre: tk.Widget):
        ...
        self.photo_sur_canvas=self.canvas.create_image(0,0, anchor = tk.NW, image=self.photo) 
    ...
    def effacerReponses(self) -> None:
        ...
        self.canvas.itemconfig(self.photo_sur_canvas, image = self.photo)   
