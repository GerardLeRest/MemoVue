...
class ModifierBDD:
    def __init__(self, chemin_fichier):
        ...
        self.eleves_par_classes = {}  # Par classe (utile pour la recherche)
    ...
    def charger_eleves_et_classes(self):
        ...
        for classe_nom in classes:
            ...
            self.eleves_par_classes[classe_nom] = tableau
    ...
    def eleves_classe(self, classe_nom):
        ...
        for prenom, nom, options, photo in self.curs.fetchall():
            print(f"{prenom} {nom} | Classe : {classe_nom} | Options : {options} | Photo : {photo}")
